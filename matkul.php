...
<nav class="navbar navbar-expand-lg navbar-light shadow" style="background-color: #ffb3b3 " >
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item ms-3">
                <a class="nav-link active" href="matkul.php">Daftar Mata Kuliah</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="container" style="margin-top: 40px; ">
        <div class="card" style="margin-bottom: 10px; ">
            <div class="card-body">
                <center>
                    <h1 style="margin-bottom: 25px;">Daftar Mata Kuliah</h1>
        ...
        <table class="table ">
            ...
            <th scope="col" style="text-align: center">DOSEN</th>
            
            </tr>
            </thead>
            <tbody>
            <?php
            $sql = ociparse($conn, "SELECT * FROM MATKUL");
            oci_execute($sql);
            while (ocifetch($sql)) { ?><tr>
            <th scope="row" style="text-align: center"><?php echo ociresult($sql, "ID") ?></th>
            <td style="text-align: center"><?php echo ociresult($sql, "MTKL") ?></td>
            <td style="text-align: center"><?php echo ociresult($sql, "DOSEN") ?></td>
